...
kubectl -n argocd wait pods -l app.kubernetes.io/name=argocd-server --for condition=Ready
kubectl -n argocd wait pods -l app.kubernetes.io/name=argo-rollouts --for condition=Ready
